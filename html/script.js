$(document).ready(function() {
    ...
    window.addEventListener('message', function(event) {
        ...
        if (data.action == "setupLocations") {
            setupLocations(data.last, data.locations, data.houses)
        }
...
function setupLocations(last, locations, myHouses) {
    var parent = $('.spawn-locations')
    $(parent).html("");

    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Where would you like to start?"><p><span id="null">Silahkan Pilih Lokasi!</span></p></div>')
